...
import shutil
# 定义GSX路径
GSX_ROOT=input('Please enter your GSX Root(until "texture"):')
Texture_ROOT=input('Please enter your Texture Root:')

# 复制文件
shutil.copytree((os.path.join(Texture_ROOT,"catering")),os.path.join(GSX_ROOT))
shutil.copytree((os.path.join(Texture_ROOT,"handling")),os.path.join(GSX_ROOT))
shutil.copytree((os.path.join(Texture_ROOT,"jetwaylogo")),os.path.join(GSX_ROOT))
